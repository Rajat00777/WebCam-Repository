<!--
    Link Is :- itsolutionstuff.com/post/php-webcam-capture-image-and-save-from-cameraexample.html 
-->
...
<head>
    ...
    <style type="text/css">
        #results { padding:20px; border:1px solid; background:greenyellow; }
    </style>
</head>
<body>
